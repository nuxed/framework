...
class IniFileLoaderTest extends LoaderTest<string> {
  ...
  public function provideLoadData(
    ...
    return vec[
      tuple(__DIR__.'/../fixtures/messages.en.ini', 'en', 'messages', $en),
      tuple(__DIR__.'/../fixtures/messages.fr.ini', 'fr', 'messages', $fr),
    ];
  }
}
