...
class CacheServiceProvider implements Container\ServiceProviderInterface {
  ...
  public function register(Container\ContainerBuilder $builder): void {
    $builder->add(CacheInterface::class, new Cache\CacheFactory(), true);
    ...
    $builder->add(
      ...
      Container\factory(
        ($container) ==> new Cache\Store\ApcStore(
          $namespace,
          $defaultTtl,
          $container->get(Cache\Serializer\SerializerInterface::class),
        ),
      ),
      true,
    );
    ...
    $builder->add(
      Cache\Store\StoreInterface::class,
      Container\factory(
    ...
    $builder->add(
      Cache\Serializer\SerializerInterface::class,
      Container\factory(
        ($container) ==> $container->get(
          Shapes::idx(
            $this->config,
