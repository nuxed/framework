...
interface MessageInterface {
   ...
   *
   * @return KeyedContainer<string, Container<string>> Returns an associative KeyedContainer of the message's headers. Each
   *     key MUST be a header name, and each value MUST be a Container of strings
   *     for that header.
   */
   ...
   *
   * @param string $name Case-insensitive header field name.
   * @param Container<string> $value Header values.
   *
   * @throws \InvalidArgumentException for invalid header names or values.
   */
  public function withHeader(string $name, Container<string> $values): this;
